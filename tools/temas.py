...
THEMES = {
 ...
 'marino': {
  'light': dict(bg='#f7f9fd', card='#ffffff', hover='#edf2fa', col='#f0f4fb',
    text='#0b1a33', text2='#46577a', text3='#606f92',
    accent='#1f6fe0', fill='#1a5fc8', onfill='#ffffff', asoft='#e7f0ff', atext='#16509f',
    border='#e3e9f3', border2='#ccd6e8',
    danger='#c22c36', dsoft='#fdecee', ok='#1c7a54', oksoft='#e6f5ee', info='#16509f', isoft='#e7f0ff', wsoft='#fdf2d7', wtext='#6f5200',
    side='#0b1a33', sidetext='#b9c6de', sidestrong='#ffffff', sidehover='#152744', sideon='#1d3255', sideontext='#ffffff', sidemuted='#93a3c1', sideborder='#152744', snote='#33291a', snotetext='#f2c46b',
    shadow='11, 26, 51'),
  'dark': dict(bg='#0a1526', card='#121f36', hover='#1a2942', col='#0f1b2e',
    text='#e8eefb', text2='#a9b8d4', text3='#8a9ab9',
    accent='#4da3ff', fill='#4da3ff', onfill='#04122b', asoft='#13294a', atext='#8fc2ff',
    border='#1b2b45', border2='#2b3e5d',
    danger='#ff8a93', dsoft='#3a1d24', ok='#5fd3a0', oksoft='#12332a', info='#8fc2ff', isoft='#13294a', wsoft='#33291a', wtext='#f2c46b',
    side='#07101f', sidetext='#a9b8d4', sidestrong='#ffffff', sidehover='#101c30', sideon='#16253d', sideontext='#ffffff', sidemuted='#8a9ab9', sideborder='#111e33', snote='#33291a', snotetext='#f2c46b',
    shadow='0, 0, 0'),
 },
 'foco': {
